...
abbr --add jbmd "jj bookmark move dev --from"
abbr --add jbmm "jj bookmark move main --from"
abbr --add jbs "jj bookmark set"
abbr --add jbsd "jj bookmark set dev -r @-"
abbr --add jbsm "jj bookmark set main -r @-"
abbr --add jbt "jj bookmark track"
abbr --add jc "jj commit -m"
abbr --add jd "jj diff"
abbr --add jdr "jj diff -r"
abbr --add jds "jj diff -s"
abbr --add je "jj edit"
...
abbr --add ns "sudo darwin-rebuild switch --flake ~/.config/nix-darwin --impure"
abbr --add nu "nix flake update --flake ~/.config/nix-darwin"
abbr --add ofd "open ."
abbr --add p "pnpm"
