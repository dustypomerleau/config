...
/usr/sbin:\
$PATH"
# $HOME/.asdf/installs/rust/1.48.0/bin:\
# alternatively you can source ~/.ghcup/env to get the cabal and ghcup executables in your path - issue with this is that it requires ghcup and might not be there if you only use brew installs
